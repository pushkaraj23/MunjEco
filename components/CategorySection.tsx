...
export function CategorySection({ categories }: Props) {
  ...
  return (
    <section
      ref={ref}
      className="relative border-t border-border/60 bg-background px-6 py-20 md:py-28"
    >
      ...
      <div className="relative mx-auto flex max-w-7xl flex-col gap-14 lg:flex-row">
