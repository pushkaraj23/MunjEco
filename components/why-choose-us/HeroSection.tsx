    ...
    <section className="relative overflow-visible bg-background pt-28 pb-12 md:pt-32 md:pb-16">
      ...
      <div className="mx-auto max-w-6xl 2xl:max-w-7xl px-8 sm:px-10 md:px-12 lg:px-16 xl:px-20">
        <motion.div
          ...
          className="grid gap-10 md:grid-cols-[minmax(0,1.2fr)_minmax(0,1fr)] md:items-end"
        >
          ...
          <div className="relative aspect-[5/3] overflow-hidden border border-border/70 bg-background-alt shadow-card">
            <Image
